...
* Todo [16/22] [72%]
  ...
  19. [X] fix "import urlerrors" to work when imported in urlparser and urlbuilder
  20. [X] Put UnbuiltURLError into urlbuilder.build()
  21. [X] fix importing from "import urlformat.urlformat.urlparser as urlparser" to "from urlformat import UrlParser"
  22. [ ] move linter.sh to /urlformat instead of /urlformat/urlformat and update it
