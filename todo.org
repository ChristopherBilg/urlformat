...
* Todo [20/28] [71%]
  ...
  28. [ ] linter.sh/test.sh
      1. [ ] Add bash script arguments to only apply yapf linting when wanted
      2. [ ] Add bash script to itterate over all python files and format them
